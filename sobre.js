...
// Listener do formulário (fora da função)
...
function dicasDeInvestimento() {
  ...
  // Mostra somente a seção de dicas
  const secao = document.getElementById("dicas");
  if (secao) {
      secao.style.display = "block";
  } else {
      console.error("❌ ERRO: A seção #dicas não existe no HTML.");
  }
}
